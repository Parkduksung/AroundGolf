    ...
    public void start() throws IOException, MqttException {
        ...
        try {
            ...
            if(GlobalStatic.SCREENSET_PROXYUSE){
                ...
                String proxyIp = GlobalStatic.g_setinfoProxyAddr;
                int proxyPort = Integer.valueOf(GlobalStatic.g_setinfoProxyPort);
                String host = this.host;
                int port = this.port;

                String proxyUserId = GlobalStatic.g_setinfoProxyID;
                String proxyUserPwd = GlobalStatic.g_setinfoProxyPasswd;
